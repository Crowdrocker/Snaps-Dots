[![jp](https://img.shields.io/badge/lang-jp-blue.svg)](https://github.com/Crowdrocker/Snaps-Dots/blob/main/i18n/README.jp.md)
[![ro](https://img.shields.io/badge/lang-ro-green.svg)](https://github.com/Crowdrocker/Snaps-Dots/blob/main/i18n/README.ro.md)
[![ru](https://img.shields.io/badge/lang-ru-red.svg)](https://github.com/Crowdrocker/Snaps-Dots/blob/main/i18n/README.ru.md)
[![ua](https://img.shields.io/badge/lang-ua-white.svg)](https://github.com/Crowdrocker/Snaps-Dots/blob/main/i18n/README.ua.md)
[![de](https://img.shields.io/badge/lang-de-magenta.svg)](https://github.com/Crowdrocker/Snaps-Dots/blob/main/i18n/README.de.md)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Crowdrocker/Snaps-Dots/main/assets/latte.png" width="400" />
</p>
...
<br>
  ...
  <a href="https://github.com/Crowdrocker/Snaps-Dots/wiki"><kbd> <br> Wiki <br> </kbd></a>&ensp;&ensp;
  <a href="https://github.com/Crowdrocker/Snaps-Dots/discussions"><kbd> <br> Discussions <br> </kbd></a>&ensp;&ensp;
  <a href="https://github.com/Crowdrocker/Snaps-Dots/wiki/Keybinds"><kbd> <br> Keybinds <br> </kbd></a>&ensp;&ensp;
  <a href="https://discord.gg/kool-tech-world"><kbd> <br> Discord <br> </kbd></a>
</div><br>

<div align="center">

![GitHub Repo stars](https://img.shields.io/github/stars/Crowdrocker/Snaps-Dots?style=for-the-badge&color=cba6f7) ![GitHub last commit](https://img.shields.io/github/last-commit/Crowdrocker/Snaps-Dots?style=for-the-badge&color=b4befe) ![GitHub repo size](https://img.shields.io/github/repo-size/Crowdrocker/Snaps-Dots?style=for-the-badge&color=cba6f7) <a href="https://discord.gg/kool-tech-world"> <img src="https://img.shields.io/discord/1151869464405606400?style=for-the-badge&logo=discord&color=cba6f7&link=https%3A%2F%2Fdiscord.gg%kool-tech-world"> </a>
...
```bash
sh <(curl -L https://raw.githubusercontent.com/Crowdrocker/Snaps-Dots/main/Distro-Hyprland.sh)
```
...
- [Arch-Linux](https://github.com/Crowdrocker/Snaps-Arch-Hyprland)
...
### 📦 Whats new?
- To easily track changes, I will be updating the [CHANGELOGS](https://github.com/Crowdrocker/Snaps-Dots/wiki/Changelogs)  Screenshots will be included if worth mentioning the changes!

> [!NOTE]
> Kindly note that by defeault, Kools Dots are adjusted / configured for 2k (1440p) display without scaling. 

### 💥 Copying / Installation / Update instructions 💥
- [`MORE INFO HERE`](https://github.com/Crowdrocker/Snaps-Dots/wiki/Install_&_Update) 
> [!Note] 
...
```bash
git clone --depth=1 https://github.com/Crowdrocker/Snaps-Dots.git
cd Snaps-Dots
```

> to download from Development branch (development and testing)
```bash
git clone --depth=1 https://github.com/Crowdrocker/Snaps-Dots.git -b development
cd Snaps-Dots
```
...
- I am getting ridiculously amount of messages for updating your KooL Hyprland dotfiles. I have made a BIG note on [`WIKI`](https://github.com/Crowdrocker/Snaps-Dots/wiki/Install_&_Update)
...
- by default, only few wallpapers will be copied (1 each dark and light plus 3 more). You will be offered to download more wallpapers. You can preview/check the additional wallpapers from [`THIS`](https://github.com/Crowdrocker/Wallpaper-Bank/tree/main/wallpapers) Link
...
- NVIDIA users / owners, after installation, check [`THIS`](https://github.com/Crowdrocker/Snaps-Dots/wiki/Notes_to_remember#--for-nvidia-gpu-users)

+ If you have already set your own keybinds, monitors, etc.... Just copy over from backup created before log-out or reboot. (recommended)


#### 📖 Known issues and possible solutions
- check out this page [FAQ](https://github.com/Crowdrocker/Snaps-Dots/wiki/FAQ) and [UNSOLVED ISSUES](https://github.com/Crowdrocker/Snaps-Dots/wiki/Known_Issues)
...
- More question? click here browse through this [WIKI](https://github.com/Crowdrocker/Snaps-Dots/wiki/)
- If you want the old configs, it is collected on my "Archive" repo. See [HERE](https://github.com/Crowdrocker/Snaps-Dots-releases-Archive)

#### ⌨ Keybinds
- Keybinds [`CLICK`](https://github.com/Crowdrocker/Snaps-Dots/wiki/Keybinds)
...
#### ✍️ Contributing
- Want to contribute? Click [`HERE`](https://github.com/Crowdrocker/Snaps-Dots/blob/main/CONTRIBUTING.md) for a guide how to contribute
